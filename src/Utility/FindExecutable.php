...
trait FindExecutable
{
    ...
    /**
     * Look for a "{$cmd}.phar" in the current working directory; return a
     * string to exec it if it is found.  Otherwise, look for an executable
     * command of the same name via findExecutable.
     *
     * @param string $cmd
     *   The phar command to find.
     *
     * @return bool|string
     */
